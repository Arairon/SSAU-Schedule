...
const useEditorState = create<EditorState>((set) => ({
  ...
  time: null,
  customizationData: {},
  setCustomizationData: (customizationData: Partial<CustomizationData>) =>
  ...
  openDeleteDialog: ({ lesson }) =>
    set({ lesson, isDeleteDialogOpen: true, customizationData: {} }),
  openEditDialog: ({ lesson, time }) =>
    set({
      lesson,
      time,
      isEditDialogOpen: true,
      customizationData: lesson ? getLessonCustomization(lesson) : time,
    }),
  close: () =>
    set({
      isEditDialogOpen: false,
