-- CreateEnum
CREATE TYPE "public"."LessonType" AS ENUM ('Lection', 'Lab', 'Practice', 'Other', 'Exam', 'Consult', 'Military', 'Window', 'Unknown');
...
-- CreateIndex
CREATE INDEX "WeekImage_stylemap_timetableHash_idx" ON "public"."WeekImage"("stylemap", "timetableHash");

-- CreateIndex
CREATE UNIQUE INDEX "WeekImage_stylemap_timetableHash_key" ON "public"."WeekImage"("stylemap", "timetableHash");
...
-- AddForeignKey
ALTER TABLE "public"."UserIcs" ADD CONSTRAINT "UserIcs_id_fkey" FOREIGN KEY ("id") REFERENCES "public"."User"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "public"."GroupIcs" ADD CONSTRAINT "GroupIcs_id_fkey" FOREIGN KEY ("id") REFERENCES "public"."Group"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "public"."Week" ADD CONSTRAINT "Week_groupId_fkey" FOREIGN KEY ("groupId") REFERENCES "public"."Group"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "public"."_GroupToLesson" ADD CONSTRAINT "_GroupToLesson_A_fkey" FOREIGN KEY ("A") REFERENCES "public"."Group"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "public"."_GroupToLesson" ADD CONSTRAINT "_GroupToLesson_B_fkey" FOREIGN KEY ("B") REFERENCES "public"."Lesson"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "public"."_FlowToLesson" ADD CONSTRAINT "_FlowToLesson_A_fkey" FOREIGN KEY ("A") REFERENCES "public"."Flow"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "public"."_FlowToLesson" ADD CONSTRAINT "_FlowToLesson_B_fkey" FOREIGN KEY ("B") REFERENCES "public"."Lesson"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "public"."_FlowToUser" ADD CONSTRAINT "_FlowToUser_A_fkey" FOREIGN KEY ("A") REFERENCES "public"."Flow"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "public"."_FlowToUser" ADD CONSTRAINT "_FlowToUser_B_fkey" FOREIGN KEY ("B") REFERENCES "public"."User"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "public"."_LessonToWeek" ADD CONSTRAINT "_LessonToWeek_A_fkey" FOREIGN KEY ("A") REFERENCES "public"."Lesson"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "public"."_LessonToWeek" ADD CONSTRAINT "_LessonToWeek_B_fkey" FOREIGN KEY ("B") REFERENCES "public"."Week"("id") ON DELETE CASCADE ON UPDATE CASCADE;
