...
Это позволит другим пользователям, которые не вошли в ЛК, получать своё расписание из API личного кабинета через ваш аккаунт. \
Ваши данные не будут видны други пользователям, а на вашем аккаунте не будет выполняться никаких действий, кроме получения данных о расписании.
`,
    {
      reply_markup: new InlineKeyboard()
