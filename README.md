...
SCHED_BOT_INTERNAL_API_SECRET= # Общий секрет для внутренних API (>=64 символов)
...
# Для вынесенного сервиса apps/telegram-bot (опционально, пока есть fallback)
SCHED_BOT_DISPATCH_URL=http://telegram-bot:3040/api/internal/dispatch/send
SCHED_BOT_DISPATCH_TIMEOUT_MS=10000
```
